...
public class Student {
    // utd.dallas.backend.Student Variables
     ...
     * @return utd.dallas.backend.Course object that has the highest GPA
     */
    ...
    * be displayed the final utd.dallas.backend.Audit PDF.
    */
